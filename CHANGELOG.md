...
### Fixed
- **Updater** — no more "access is denied" on update. The new version downloads as `Wingosy_update.exe` alongside the current exe; the user is prompted to close and run it manually.
